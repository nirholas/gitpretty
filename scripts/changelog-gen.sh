...
usage() {
    echo "📋 changelog-gen.sh - Generate changelogs from emoji commits"
    echo ""
...
CATEGORIES["💄"]="💄 UI/Style"
CATEGORIES["♻️"]="♻️ Refactoring"
CATEGORIES["🔧"]="🔧 Configuration"
CATEGORIES["✅"]="✅ Tests"
CATEGORIES["🔒"]="🔒 Security"
CATEGORIES["⬆️"]="⬆️ Dependencies"
CATEGORIES["⬇️"]="⬇️ Dependencies"
CATEGORIES["🏗️"]="🏗️ Architecture"
CATEGORIES["📦"]="📦 Build"
CATEGORIES["🔀"]="🔀 Merges"
...
generate_md() {
    ...
    while IFS='|' read -r hash date author msg; do
        # Extract first emoji
        emoji=$(echo "$msg" | grep -oE "^[🎉✨🐛🔥📝🚀💄♻️🔧✅🔒⬆️⬇️🏗️📦🔀🚧🚑⏪💚👷📌]" | head -1)
    ...
    # Output grouped
    for category in "✨ Features" "🐛 Bug Fixes" "📝 Documentation" "♻️ Refactoring" "🔧 Configuration" "✅ Tests" "🔒 Security" "⬆️ Dependencies" "🏗️ Architecture" "📦 Build" "🚑 Hotfixes" "📌 Other"; do
